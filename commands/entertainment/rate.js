...
module.exports={
    ...
    run: async(bot,message,args)=>{
        ...
        const formattedMsgs = erole.members.map(m => `${m.tag}`)
        ...
        if(!message.mentions.members.first().hasPermission('PRIORITY_SPEAKER')) return message.channel.send(`This user isnt a egirl stuped; ${formattedMsgs}. `)
        message.delete()
