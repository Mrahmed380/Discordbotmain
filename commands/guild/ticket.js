...
module.exports={
    ...
    run: async(bot,message,args)=>{
            ...
            if(message.guild.channels.cache.find(ch => ch.name == ctname)) return message.author.send('You alredy have a ticket open, go to your ticket channel and type e!cticket to close your current ticket!')
